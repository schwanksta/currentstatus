...
currentstatus_fm.body = document.body;
...
var G__24557_24562 = (new cljs.core.Keyword("\ufdd0'bind")).call(null, jayq.core.ajax_m);
var G__24558_24563 = (new cljs.core.Keyword("\ufdd0'return")).call(null, jayq.core.ajax_m);
var G__24559_24564 = (new cljs.core.Keyword("\ufdd0'zero")).call(null, jayq.core.ajax_m);
G__24557_24562.call(null, cljs.core.ObjMap.fromObject(["\ufdd0'url", "\ufdd0'dataType"], {"\ufdd0'url":"http://search.twitter.com/search.json?q=current%20status%20youtu.be&include_entities=true", "\ufdd0'dataType":"\ufdd0'jsonp"}), function(data) {
  return G__24558_24563.call(null, jayq.core.append.call(null, currentstatus_fm.container, dommy.template.node.call(null, cljs.core.PersistentVector.fromArray(["\ufdd0'ul", function() {
    var iter__2540__auto__ = function iter__24560(s__24561) {
      return new cljs.core.LazySeq(null, false, function() {
        var s__24561__$1 = s__24561;
        while(true) {
          if(cljs.core.seq.call(null, s__24561__$1)) {
            var r = cljs.core.first.call(null, s__24561__$1);
            return cljs.core.cons.call(null, cljs.core.PersistentVector.fromArray(["\ufdd0'li", currentstatus_fm.get_youtube_embed.call(null, r)], true), iter__24560.call(null, cljs.core.rest.call(null, s__24561__$1)))
          }else {
            return null
          }
          break
